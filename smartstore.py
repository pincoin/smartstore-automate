...
if __name__ == '__main__':
    ...
    if len(files) == 1 and files[0].endswith('.xlsx'):
        ...
        if order_count > 0:
            ...
            logger.info('일괄발송 엑셀 로컬 삭제')

        wb_order.close()
        os.remove(files[0])
        logger.info('엑셀 로컬 삭제')
